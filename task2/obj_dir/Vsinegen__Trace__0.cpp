...
void Vsinegen___024root__trace_chg_0_sub_0(Vsinegen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+4,(vlSelfRef.offset),8);
    bufp->chgCData(oldp+5,(vlSelfRef.data1),8);
    bufp->chgCData(oldp+6,(vlSelfRef.data2),8);
    bufp->chgCData(oldp+7,(vlSelfRef.sinegen__DOT__address1),8);
    bufp->chgCData(oldp+8,((0xffU & ((IData)(vlSelfRef.offset) 
