...
void Vsigdelay___024root__trace_chg_0_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgCData(oldp+4,(vlSelfRef.incr),8);
    bufp->chgCData(oldp+5,(vlSelfRef.offset),8);
    bufp->chgCData(oldp+6,(vlSelfRef.mic_signal),8);
    bufp->chgCData(oldp+7,(vlSelfRef.delayed_signal),8);
    bufp->chgCData(oldp+8,(vlSelfRef.sigdelay__DOT__address1),8);
    bufp->chgCData(oldp+9,((0xffU & ((IData)(vlSelfRef.offset) 
