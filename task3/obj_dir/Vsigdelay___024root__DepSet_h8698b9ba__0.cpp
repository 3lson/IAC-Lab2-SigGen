...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__Vdly__sigdelay__DOT__address1 = vlSelfRef.sigdelay__DOT__address1;
    if (vlSelfRef.rst) {
        vlSelfRef.__Vdly__sigdelay__DOT__address1 = 0U;
    } else if (vlSelfRef.rd) {
        vlSelfRef.__Vdly__sigdelay__DOT__address1 = 
            (0xffU & ((IData)(vlSelfRef.sigdelay__DOT__address1) 
...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__1(Vsigdelay___024root* vlSelf) {
    ...
    CData/*7:0*/ __VdlyDim0__sigdelay__DOT__SineRam__DOT__ram_array__v0;
    ...
    if (vlSelfRef.wr) {
        ...
        __VdlyDim0__sigdelay__DOT__SineRam__DOT__ram_array__v0 
            = vlSelfRef.sigdelay__DOT__address1;
    ...
    if (vlSelfRef.rd) {
        vlSelfRef.delayed_signal = vlSelfRef.sigdelay__DOT__SineRam__DOT__ram_array
            [(0xffU & ((IData)(vlSelfRef.offset) + (IData)(vlSelfRef.sigdelay__DOT__address1)))];
    }
...
VL_INLINE_OPT void Vsigdelay___024root___nba_sequent__TOP__2(Vsigdelay___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.sigdelay__DOT__address1 = vlSelfRef.__Vdly__sigdelay__DOT__address1;
}
